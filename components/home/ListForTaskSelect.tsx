...
const ListResultForTask = ({
  ...
  return (
    <Select
      ...
      placeholder={
        <span className="px-24px body1 text-fontSecondary body1">
          リストを選択...
        </span>
      }
      components={{
        NoOptionsMessage: () => (
          <div className="px-24px py-12px body1">オプションはありません</div>
        ),
        ...
        Option: (props) => {
          return !props.isDisabled ? (
            <LIST_SELECTITEM
              ...
              additionalClass=" hover:bg-primarySelected hover:text-primary cursor-pointer body1"
              {...props.innerProps}
            />
          ) : null;
        },
          ...
          return (
            <components.SingleValue {...props}>
              <LIST_SELECTITEM
                ...
                additionalClass="body1"
              />
            </components.SingleValue>
          );
        },
        MenuList: (props) => {
          return <LIST_MENULIST {...props} type={1} />;
        },
      }}
    />
  );
...
export default ListResultForTask;
