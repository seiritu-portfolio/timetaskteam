...
const Policy = () => {
  ...
  return (
    <div className="h-full flex flex-col">
      <SettingsHeader title={`利用規約・ポリシー`} />
      <div className="mt-36px mx-24px h-40px rounded-6px border-2 border-backgroundSecondary bg-backgroundPrimary body3 flex cursor-pointer">
        <span
      ...
      <div className="p-24px w-full body1">
        {activeTab === 0 ? (
          <>
